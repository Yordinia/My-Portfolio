...
section.innerHTML = `
  ...
  <div class="disp-project">See Live <img src='../src/images/seeLive.svg' width='18px' height= '18px'></div>
  <div class="disp-project">See Source <img src='../src/images/seeSource.svg' width= '18px'  height= '18px'></div>
  </div>
  </div>
  `;
